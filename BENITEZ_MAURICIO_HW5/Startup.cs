...
namespace BENITEZ_MAURICIO_HW5
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server = tcp:sp21mauriciobenitezhw5.database.windows.net,1433; Initial Catalog = sp21mauriciobenitezHW5; Persist Security Info = False; User ID = MISAdmin; Password=HelloWorld!; MultipleActiveResultSets = True; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30;";
